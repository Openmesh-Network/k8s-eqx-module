  ...
  WORKLOADS=$(cat <<_EOF
{
  ...
  "cni_workloads": [
    "https://projectcalico.docs.tigera.io/archive/v3.24/manifests/tigera-operator.yaml",
    "https://projectcalico.docs.tigera.io/archive/v3.24/manifests/custom-resources.yaml"
  ],
  "extra": "",
  ...
  "applied_at": "2023-04-10:10:04:09"
}
_EOF
)
jq . <<< $WORKLOADS > $HOME/workloads.json
}
